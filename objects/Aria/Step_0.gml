...
if (just_rescued && room == rmPool){
	ctb_list(noone, noone, 
		"[set_speaker:Aria]"+cmd_ex(ex_smile)+"Thank you so so much for saving me! I don't even know I can thank you.",
		cmd_ex(ex_idle)+"[set_speaker:Player] Please don't worry about it. (Dev note: add more dialogue lol)",
		"[set_speaker:Aria]"+cmd_ex(ex_talk)+" Do you come here often?",
		"[set_speaker:Player] Uhh yes!",
		"[set_speaker:Aria]"+cmd_ex(ex_blush)+" Then please, would you mind giving me swim lessons? My previous swim teacher had to leave. I'll pay you $30 per session!",
		"[set_speaker:Player](You shook your head saying you don't need payment for this.)",
		"[set_speaker:Aria]"+cmd_ex(ex_surprise)+" Please! I can't ask you to do this for free.",
		...
		"[set_speaker:Aria]"+cmd_ex(ex_smile2)+" Thank you so much! I will be here from 7 to 9 am every monring. Come whever you can!", 
