function msg_Bambi_intro_EN(){
	ctb_list(noone, rmBarn ,
		 "[speaker:???][ex:ex_surprise]Oooh, Please stop Mr.Chicken!",
		...
		"[speaker:???][ex:ex_blush]You don't look like a farm girl but I'll take anything at this point!",
		...
		"[ex:idle][speaker:???]Thank you so much for all your help!",
	);
}
